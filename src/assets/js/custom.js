import $ from 'jquery';
import '../js/jquery.meanmenu.js'; // Adjust the path to your plugin
...
jQuery(function ($) {
	...
	// Back to Top JS 
	$('body').append('<div id="toTop" class="back-to-top-btn"><i class="fa fa-arrow-up" aria-hidden="true"></i></div>');
