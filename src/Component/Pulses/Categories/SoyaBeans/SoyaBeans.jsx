...
import SoyaBeansTopHeader from './SoyaBeansTopHeader';
const SoyaBeans = () => {
  ...
  const toggleIcon = (key) => {
    ...
    return (
        <div>
            ...
            <SoyaBeansTopHeader></SoyaBeansTopHeader>
            <div className="job-area job-area-two job-area-three">
  <div className="container-fluid">
    <div className="row m-0">
      <div className="col-lg-6">
        <div className="job-img">
          <img src="/img/products/pulses/Soybean.jpg" alt="cattle feed" />
        </div>
      </div>
      <div className="col-lg-6">
        <div className="job-content job-content_02">
          <div className="section-title">
            ...
            <h1 className="log_1">Soya Beans</h1>
          </div>
          <p>
            Soya beans, also known as soybeans, are a highly versatile and nutritious legume that offers a wide range of health benefits. These beans are packed with protein, dietary fiber, and essential vitamins and minerals.<br />
        ...
        <div className="row faq-wrap" style={{ alignItems: 'center' }}>
          <div className="col-lg-9">
            <div className="faq-head section-title text-start">
              <span className="sub-title">Soya Beans</span>
            ...
            <div className="faq-item pb-70">
              <Accordion activeKey={activeKey} onSelect={(key) => setActiveKey(key)}>
                <Accordion.Item eventKey="0" className="mb-2">
                  ...
                  <Accordion.Body>
                    Soya beans, also known as soybeans, are incredibly versatile and can be used in a variety of ways in the kitchen. They can be cooked and enjoyed as a nutritious side dish, added to soups, stews, and stir-fries for an extra boost of protein and texture, or mashed into spreads and dips.
                  </Accordion.Body>
                </Accordion.Item>
                ...
                <Accordion.Item eventKey="1" className="mb-2">
                  ...
                  <Accordion.Body>
                    Soya beans, also known as soybeans, are a powerhouse of nutrition. A 100-gram serving of cooked soya beans contains approximately 173 calories, 16.6 grams of protein, 8.8 grams of carbohydrates, and 9 grams of fat. They are a complete source of protein, providing all the essential amino acids needed by the body.
                  </Accordion.Body>
                </Accordion.Item>
                ...
                <Accordion.Item eventKey="2" className="mb-2">
                  ...
                  <Accordion.Body>
                    They are low in saturated fat and cholesterol, making them a heart-healthy choice. Soya beans are rich in iron, calcium, and magnesium, which support bone health and muscle function. They also contain phytochemicals called isoflavones, which have antioxidant properties and may help reduce the risk of certain chronic diseases.
                  </Accordion.Body>
                </Accordion.Item>
              </Accordion>
...
<section className="benefit-area mt-0 mb-150" style={{ backgroundImage: "url(/img/masala/other-spices/seeds/seeds.jpg)" }}>
  <div className="container">
    <div className="benefit-content">
      <div className="section-title">
        <span className="sub-title">SOYA BEANS</span>
        <h2>Get Benefits of Using Fortune Soya Beans</h2>
      </div>
      <p>
        They are a high-quality plant-based protein source, promoting muscle growth. Soya beans are heart-healthy, low in saturated fat, rich in unsaturated fats that support cardiovascular health. Their fiber content aids in digestion, promotes a healthy gut. Soya beans also contribute to maintaining steady blood sugar levels, supporting weight management due to their low glycemic index content. Additionally, they contain essential minerals for bone health, support hormonal balance, offer antioxidant properties, provide a range of vitamins.
      </p>
      <div className="row">
    ...
    <div className="row">
      ...
      <div className="col-md-5 me-auto ms-auto">
        <div className="service-item service-item_02">
          ...
          <h3>
            <a href="javascript:void(0);">Heart-healthy</a>
          </h3>
          <p>Soya beans are low in saturated fat and cholesterol and high in unsaturated fats, including omega-3 fatty acids.</p>
        </div>
      </div>
      <div className="col-md-5 me-auto ms-auto">
        <div className="service-item service-item_02">
          ...
          <h3>
            <a href="javascript:void(0);">Bone health</a>
          </h3>
          <p>Soya beans are rich in calcium, magnesium, and phosphorus, which are essential minerals for maintaining strong and healthy bones.</p>
        </div>
      </div>
      <div className="col-md-5 me-auto ms-auto">
        <div className="service-item service-item_02">
          ...
          <p>The high fiber content in soya beans promotes healthy digestion, prevents constipation, and supports a healthy gut microbiome.</p>
        </div>
      </div>
      <div className="col-md-5 me-auto ms-auto">
        <div className="service-item service-item_02">
          ...
          <p>Soya beans have a low glycemic index and contain complex carbohydrates, which help regulate blood sugar levels and provide sustained energy.</p>
        </div>
      </div>
    </div>
  </div>
