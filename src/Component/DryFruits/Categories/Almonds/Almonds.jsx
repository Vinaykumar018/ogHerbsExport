...
import AlmondsTopHeader from './AlmondsTopHeader';
...
const Almonds = () => {
  ...
  const toggleIcon = (key) => {
    ...
    return (
        <div>
            <AlmondsTopHeader></AlmondsTopHeader>
    ...
    <div className="row m-0">
      <div className="col-lg-6">
        <div className="job-img">
          <img src="/img/products/dry-fruits/almonds.jpg" alt="cattle feed" />
        </div>
      </div>
      <div className="col-lg-6">
        <div className="job-content job-content_02">
          <div className="section-title">
            ...
            <h1 className="log_1">Almonds</h1>
          </div>
          <p>
            Almonds, scientifically known as Prunus dulcis, are delicious, nutritious tree nuts that have been enjoyed for centuries. 
            Native to the Middle East, almonds are now cultivated worldwide due to their popularity.<br />
            ...
            <strong>Indian Areas:</strong> Bihar, Assam, Gujarat, Himachal Pradesh, Delhi, Mumbai, Orissa, Punjab, West Bengal, 
            Madhya Pradesh, Rajasthan, Sikkim, West Bengal, Haryana, Andhra Pradesh, Hyderabad, Maharashtra, Chandigarh, 
            Jharkhand, Uttarakhand, Goa, etc.<br />
          </p>
          <a className="cmn-btn" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">Inquiry Now</a>
        </div>
      </div>
    </div>
  </div>
        ...
        <div className="row faq-wrap" style={{ alignItems: 'center' }}>
          <div className="col-lg-9">
            <div className="faq-head section-title text-start">
              <span className="sub-title">Almonds</span>
            ...
            <div className="faq-item pb-70">
              <Accordion activeKey={activeKey} onSelect={(key) => setActiveKey(key)}>
                <Accordion.Item eventKey="0" className="mb-2">
                  ...
                  <Accordion.Body>
                    Almonds have a wide range of culinary uses and can be enjoyed in various ways. They are commonly eaten as a snack on their own, both raw and roasted, providing a satisfying crunch. Almonds can also be used as a versatile ingredient in cooking.
                  </Accordion.Body>
                </Accordion.Item>
                ...
                <Accordion.Item eventKey="1" className="mb-2">
                  ...
                  <Accordion.Body>
                    Almonds are a nutrient-dense food, rich in essential vitamins and minerals. A 1-ounce (28 grams) serving of almonds provides approximately 164 calories, 6 grams of protein, 14 grams of fat, 6 grams of carbohydrates, and 3.5 grams of fiber.
                  </Accordion.Body>
                </Accordion.Item>
                ...
                <Accordion.Item eventKey="2" className="mb-2">
                  ...
                  <Accordion.Body>
                    Almonds are not only a versatile ingredient in various culinary preparations, but they are also a powerhouse of nutrients.
                  </Accordion.Body>
                </Accordion.Item>
              </Accordion>
...
<section className="benefit-area mt-0 mb-150" style={{ backgroundImage: 'url(/img/masala/other-spices/dry-fruits/dry-fruits.jpg)' }}>
  <div className="container">
    <div className="benefit-content">
      <div className="section-title">
        <span className="sub-title">ALMONDS</span>
        <h2>Get Benefits of Using Fortune Almonds</h2>
      </div>
      <p>
        Using almonds offers a multitude of benefits. They promote heart health due to their monounsaturated fats, provide essential nutrients 
        like vitamin E and magnesium, aid in weight management by increasing satiety, help regulate blood sugar levels, support brain health, etc.
      </p>
      <div className="row">
    ...
    <div className="row">
      ...
      <div className="col-md-5 me-auto ms-auto">
        <div className="service-item service-item_02">
          ...
          <h3><a href="javascript:void(0);">Heart Health</a></h3>
          <p>Almonds are rich in monounsaturated fats, which are considered heart-healthy fats.</p>
        </div>
      </div>
      <div className="col-md-5 me-auto ms-auto">
        <div className="service-item service-item_02">
          <i className="bx bx-bulb"></i>
          <h3><a href="javascript:void(0);">Nutrient-Rich</a></h3>
          <p>Almonds are packed with essential nutrients. They are a good source of vitamin E and magnesium.</p>
        </div>
      </div>
      <div className="col-md-5 me-auto ms-auto">
        <div className="service-item service-item_02">
          <i className="flaticon-automation"></i>
          <h3><a href="javascript:void(0);">Weight Management</a></h3>
          <p>Despite being calorie-dense, almonds can support weight management.</p>
        </div>
      </div>
      <div className="col-md-5 me-auto ms-auto">
        <div className="service-item service-item_02">
          <i className="flaticon-lab-tool"></i>
          <h3><a href="javascript:void(0);">Blood Sugar Control</a></h3>
          <p>Almonds have a low glycemic index, which means they have minimal impact on blood sugar levels.</p>
        </div>
      </div>
    </div>
  </div>
